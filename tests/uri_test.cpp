...
void test::setup_uri_tests() {
	suite("URI (scheme)", {
		test("Parses an http scheme with an authority", {
		...
		test("Parses a file scheme with an absolute path", {
		...
		test("Parses an unknown scheme with an empty path", {
		...
		test("Parses an unknown scheme with unusual albeit valid characters", {
		...
		test("Fails to parse a scheme that contains invalid characters", {
			try {
		...
		test("Fails to parse a scheme that starts with a non-ALPHA", {
			try {
	...
	suite("URI (authority)", {
		test("Parses a reg-name host without a userinfo or a port", {
		...
		test("Parses an IPv4 host without a userinfo or a port", {
		...
		test("Parses an IPv6 host without a userinfo or a port", {
		...
		test("Parses a reg-name host with a port but no userinfo", {
		...
		test("Parses an IPv4 host with a port but no userinfo", {
		...
		test("Parses an IPv6 host with a port but no userinfo", {
		...
		test("Parses a reg-name host with a userinfo but no port", {
		...
		test("Parses an IPv4 host with a userinfo but no port", {
		...
		test("Parses an IPv6 host with a userinfo but no port", {
		...
		test("Parses a reg-name host with a port and a userinfo", {
		...
		test("Parses an IPv4 host with a port and a userinfo", {
		...
		test("Parses an IPv6 host with a port and a userinfo", {
		...
		test("Parses a reg-name that starts with an IPv4 address", {
		...
		test("Fails to parse a URI with a colon at the end and no port", {
			try {
		...
		test("Fails to parse an invalid reg-name", {
			try {
